...
public class testTSelectSqlStatement extends TestCase {
    ...
    public void testDistinct(){
        ...
        TResultColumnList resultColumns = select.getResultColumnList();
        TIntoTableClause tableClause = select.getIntoTableClause();
        TQualifyClause qualifyClause = select.getQualifyClause();
